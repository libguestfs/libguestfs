...
#define CLEANUP_CAP_FREE __attribute__((cleanup(cap_freep)))
...
#define CLEANUP_CAP_TEXT_FREE __attribute__((cleanup(cap_text_freep)))
...
{
  CLEANUP_CAP_FREE cap_t cap = NULL;
  CLEANUP_CAP_TEXT_FREE char *r = NULL;
  char *ret;
